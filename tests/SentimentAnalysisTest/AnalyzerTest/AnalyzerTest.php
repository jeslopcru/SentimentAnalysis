<?php
use SentimentAnalysis\Analyzer\Analyzer;
...
class AnalyzerTest extends \PHPUnit_Framework_TestCase
{
    ...
    {
        parent::setUp();
        $this->sentiment = new Analyzer;
    }

    public function testIsPositive()
    {
        $this->assertEquals(true,
            $this->sentiment->isPositive('Marie was enthusiastic about the upcoming trip. Her brother was also passionate about her leaving - he would finally have the house for himself.'));
    ...
    public function testDecision()
    {
        ...
        $this->assertEquals('positive',
            $this->sentiment->decision('Marie was enthusiastic about the upcoming trip. Her brother was also passionate about her leaving - he would finally have the house for himself.'));
    ...
    {
        $this->assertEquals(['negative' => 0.5, 'neutral' => 0.25, 'positive' => 0.25],
            $this->sentiment->scores("Weather today is rubbish"));
        $this->assertEquals(['negative' => 0.33, 'neutral' => 0.33, 'positive' => 0.33],
            $this->sentiment->scores("To be or not to be?"));
    }
    ...
    public function testScore()
    {
        ...
        $this->assertEquals(0.57,
            $this->sentiment->score("Marie was enthusiastic about the upcoming trip. Her brother was also passionate about her leaving - he would finally have the house for himself."));
    }
}
